...
class CocktailFormState extends State<CocktailForm> {
  ...
  void initState() {
    ...
    if (widget.existingCocktail != null) {
      ...
      editMode = true;
      image = existingCocktail.image ?? null;
    }
  }
  ...
  Future<void> _pickImage() async {
    ...
    setState(() {
      if (pickedFile != null) {
        ...
        image = String.fromCharCodes(_imageFile!.readAsBytesSync());
      }
    });
  }
                    ...
                    child: Container(
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          ...
                          setState(() {
                            lengthError = lengthController.text.isNotEmpty &&
                                length == null;
                            nameError = name.isEmpty;
                            ingredientError = ingredients.isEmpty;
                          });
                          if (!nameError && !lengthError) {
                            if (editMode) {
